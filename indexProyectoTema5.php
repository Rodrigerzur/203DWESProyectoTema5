                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section_title_container text-center">
                                ...
                                <div class="section_title"><h1>TEMA 5: DESARROLLO DE APLICACIONES WEB UTILIZANDO CÓDIGO EMBEBIDO</h1></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <a href="codigoPHP/ejercicio02.php">
                                <div class="service">
                                    <div class="mostrarejercicio" data-hover="MOSTRAR EL EJERCICIO">
                                        <div class="listing_image">
                                            <div class="listing_image_container">
                                                <h3>Desarrollo de un control de acceso con identificación del usuario basado en la función header() y
                            ...
                            <a href="codigoPHP/ejercicio04.php">
                                <div class="service">
                                    <div class="mostrarejercicio" data-hover="MOSTRAR EL EJERCICIO">
                                        <div class="listing_image">
                                            <div class="listing_image_container">
                                                <h3>Implantación uso y disfrute de Xdebug en nuestro entorno de desarrollo.</h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <a href="codigoPHP/ejercicio05.php">
                                <div class="service">
                                    <div class="mostrarejercicio" data-hover="MOSTRAR EL EJERCICIO">
                                        <div class="listing_image">
                                            <div class="listing_image_container">
                                                <h3>Incorporar el control de acceso, identificación de usuario, cookies y sesiones a nuestro
                            ...
                            <a href="codigoPHP/ejercicio06.php">
                                <div class="service">
                                    <div class="mostrarejercicio" data-hover="MOSTRAR EL EJERCICIO">
                                        <div class="listing_image">
                                            <div class="listing_image_container">
                                                <h3>Ampliar la funcionalidad de la aplicación: MtoDepartamentos y MtoUsuarios.</h3>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col">
                                <div class="footer_bar_content d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-start">
                                    <div class="copyright order-md-1 order-2">
                                        2021-2022 Rodrigo Geras Zurrón     Fecha Ultima Actualización 3/12/2021 V1.1</div>
